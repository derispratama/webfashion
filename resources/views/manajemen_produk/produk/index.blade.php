                    ...
                    <table class="table table-bordered" id="table">
                        ...
                        @foreach($data as $row)
                            <tr>
                                ...
                                <td>{{$row->nama}}</td>
                                <td><img style="width: 100%;object-fit:contain; height: 100px;" src="{{asset('storage/'.$row->gambar_liga)}}" alt="gambar" class="img-thumbnail"></td>
                                <td>{{$row->stok}}</td>
                                <td>Rp.{{$row->harga}}</td>
                                <td>
                                    <a href="/produk/{{$row->id}}/edit" class="btn btn-warning btn-sm"><i class="fa fa-pencil-alt"></i></a>
