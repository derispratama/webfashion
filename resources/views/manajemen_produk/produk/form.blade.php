                ...
                <div class="card-body">
                    <form action="{{isset($data) ? '/produk/'.$data->id : '/produk'}}" method="POST" id="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" class="form-control" id="nama" placeholder="silahkan isi.." value="{{isset($data) ? $data->nama : ''}}">
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-danger" id="liga_error"></span>
                        </div>
                        <div class="form-group">
                            <label for="stok">Stok</label>
                            <input type="text" name="stok" class="form-control" id="stok" placeholder="silahkan isi.." value="{{isset($data) ? $data->stok : ''}}">
                            <span class="text-danger" id="stok_error"></span>
                        </div>
                        <div class="form-group">
                            <label for="harga">Harga</label>
                            <input type="text" name="harga" class="form-control" id="harga" placeholder="silahkan isi.." value="{{isset($data) ? $data->harga : ''}}">
